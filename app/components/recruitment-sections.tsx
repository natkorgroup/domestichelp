...
export function RecruitmentPricing() {
  return (
    <div className="pricing-grid">
      ...
      <article className="price-card price-card--featured"><span className="price-card__badge">Most complete</span><p className="price-card__eyebrow">Full household recruitment</p><div className="price-card__amount">10<span>%</span></div><p className="price-card__sub">Of your new employee’s annual salary.</p><ul><li><Check /> A tailored search and personal shortlisting</li><li><Check /> Interviews, references, and candidate checks</li><li><Check /> Help preparing the employment agreement</li><li><Check /> A 90-day replacement guarantee</li></ul><p className="price-card__credit">A $500 search commencement is credited toward your final fee.</p><a className="button button--light" href="/contact?plan=full-recruitment">Begin full recruitment <Arrow /></a></article>
    </div>
  );
}
...
export const faqs = [
  ...
  { question: "How is the full recruitment fee calculated?", answer: "The full recruitment fee is 10% of the employee’s agreed annual salary. A $500 search commencement is credited toward the final recruitment fee once a hire is made." },
  { question: "What does full household recruitment include?", answer: "Full recruitment includes a tailored search, personal shortlisting, interview coordination, relevant references and candidate checks, help preparing the employment agreement, and a 90-day replacement guarantee." },
  { question: "Can you help us prepare an employment agreement?", answer: "Yes. Families choosing full recruitment can receive practical help preparing an employment agreement that records the agreed role, schedule, compensation, and other essential working arrangements." },
