...
export const metadata: Metadata = { title: "Household Staff Recruitment Across Canada | DomesticHelp.ca", description: "Find private household staff in Toronto, Ottawa, Vancouver, Calgary, Montreal, Oakville, Westmount, and other Canadian communities.", alternates: { canonical: "/locations" } };

export default function LocationsPage() {
  return (
    <main>
      <SiteHeader />
      <InteriorHero eyebrow="Private household staffing across Canada" title="Close to the places" emphasis="you call home." description="From Toronto and Ottawa to Vancouver, Calgary, Montreal, and Westmount, we help families find experienced household staff with a thoughtful, personal approach." breadcrumbs={[{ label: "Locations" }]} />
